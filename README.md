...
<head>
    ...
    <style>
        body {background-color: green;font-family: Arial, sans-serif;color: white; padding: 20px;}
...
<body>
    <div class="content">
        <h1>Tortugas</h1>
        <div class="image">
            <img src="https://example.com/tortuga.jpg" alt="Imagen de una tortuga" width="400">
        </div>
